 ...
 */
package java_1_professional.chapter_06_ui.exemplu2.gui;

import java.awt.event.MouseAdapter;
import java.awt.event.MouseEvent;
import java.util.List;
import java_1_professional.chapter_06_ui.exemplu2.controller.Magazin;
...
public class ProdusFrame extends javax.swing.JFrame {
    ...
    public ProdusFrame() {
        initComponents();
        jButton1.addActionListener(event -> adaugaProdus());
    ...
    private void adaugaProdus() {
        ...
        Magazin.getInstance().adaugaProdus(produs);
        afisareProduse();
    }
